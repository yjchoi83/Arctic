...
- freeze-up은 **가장 중요한 계절인데 성공률이 미측정**이다. 이 공백을 메우는 것이 다음 실험 1순위다.
  **[P8 갱신 2026-09-06]** ARC-P8 step 3이 Vilkitsky·Sannikov·Long Strait 20 pair로 결빙기 성공률을
  **처음 측정했다: 0.377–0.419 (평균 0.394)**, 같은 해협 겨울은 0.484–0.779(평균 0.629).
  위 (a)열의 낙관 대입 0.47은 **약 19 % 과대**였다 → freeze-up E_state는 표의 값보다 그만큼 낮춰 읽을 것.
